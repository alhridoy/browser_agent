...
async def run_demo(headless: bool = False, slow_mo: int = 50):
    """
    Run a simple demo of the Level 2 browser automation agent.
    ...
    try:
        ...
        print("\n6. Scrolling down to see more content")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Level 2 Browser Automation Agent Simple Demo")
